...
import { Plus, Pencil, Trash2, Loader2, X, Camera, Palette, Video, Users, Award, Sparkles, Image, Star, Heart, Zap, Target, Briefcase } from "lucide-react";
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500">Kelola layanan yang ditampilkan di website</p>
                </div>
                <button
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="mt-4 flex items-center gap-2">
                                <span className={`px-2 py-1 text-xs rounded-full ${service.active ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-500"}`}>
            ...
            {services.length === 0 && (
                <div className="text-center py-12 text-gray-500">
                    Belum ada services. Klik "Tambah Service" untuk menambahkan.
                </div>
            )}
